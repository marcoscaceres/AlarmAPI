...
define(function (require) {
    ...
    TaskScheduler.prototype.add = function (taskTime, respectTZ, data) {
        return new Promise(function (resolver) {
             ...
             */
            var key = "Date:" + task_data['date'].getDate() + "-" + (task_data['date'].getMonth() + 1) + "-" + task_data['date'].getFullYear() + " " + task_data['date'].getHours() + ":" + task_data['date'].getMinutes() + ":" + task_data['date'].getSeconds() + " " + Math.round(Math.random() * 100000);
    ...
    TaskScheduler.prototype.getPendingTasks = function () {
        return new Promise(function (resolver) {
            ...
            for (var i = 0; i < old_tasks.length; i++) {
                console.log("This OLD task will be REMOVED, task date: " + localStorage.getItem(old_tasks[i].key)['date']);
